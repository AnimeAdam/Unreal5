...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_myVectorFloat_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_myVectorFloat;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_myVectorFloat_MetaData[] = {
		{ "Category", "MovingPlatform" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_myVectorFloat = { "myVectorFloat", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMovingPlatform, myVectorFloat), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_myVectorFloat_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_myVectorFloat_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_moveDistance_MetaData[] = {
		{ "Category", "Moving Platform" },
		{ "Comment", "//typedef UE::Math::TVector< double > FVector\n" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
		{ "ToolTip", "typedef UE::Math::TVector< double > FVector" },
	};
#endif
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingPlatform_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingPlatform_Statics::NewProp_myVectorFloat,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealLearningKit_Source_UnrealLearningKit_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 3745314099U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealLearningKit_Source_UnrealLearningKit_MovingPlatform_h_4082635727(TEXT("/Script/UnrealLearningKit"),
